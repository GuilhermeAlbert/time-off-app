...
Create Storybook stories for manager review states.

## Required Stories

- No pending requests
- Pending request with valid balance
- Approving
- Denied
- Approved
- Conflict at decision time
- Balance changed before approval
- Error

## Acceptance Criteria

- Balance context is visible in manager stories.
