...
Add only high-value Storybook interaction tests.

## Keep It Focused

Do not add interaction tests for every story.

Add interaction tests only where they prove important behavior.

## Required Interaction Tests

1. Request form validation.
2. Request submission shows pending, not approved.
3. Manager approval conflict displays conflict message.
4. Balance refreshed story shows refreshed notice.

## Acceptance Criteria

- Interaction tests cover critical behavior.
- They do not duplicate all component/integration tests.
- They run through Storybook test tooling available in the project.
