...
Create a short document showing what tests exist and what they protect.

## Required File

```txt
docs/coverage-proof.md
```
...
Document the real commands available in the project, such as:
...
- Document lists test coverage by behavior, not only by file.
